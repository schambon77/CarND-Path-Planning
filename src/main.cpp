...
void get_traj(double car_x, double car_y, double car_vx, double car_vy, double car_yaw, double car_s, const vector<double> &previous_path_x, const vector<double> &previous_path_y,
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
        	...
        	// Main car's localization Data
          	...
          	get_traj(car_x, car_y, 0.0, 0.0, car_yaw, car_s, previous_path_x, previous_path_y, map_waypoints_s, map_waypoints_x, map_waypoints_y, lane, ref_vel, next_x_vals, next_y_vals);
